...
public class PermissionAssignController {
	 ...
	 * 
	 * @ResponseBody public String getChiefMenu(HttpServletRequest request){
	 * Object userIDObj = request.getSession().getAttribute("USERID");
	 * if(userIDObj==null){ return null; } else { return ""; return
	 * JSONArray.fromObject
	 * (service.getChiefMenu(userIDObj.toString())).toString(); } }
	 */
	/**
	 * 读取权限树菜单 wangzhijun
	 * 
	...
	public String getPermissionModule(HttpServletRequest request, String level) {
		...
		if (userIDObj == null) {
			...
			return JSONArray.fromObject(
					service.getPermissionModule(userIDObj.toString(), level,
							loginName)).toString();
		}
	}
	...
	public String getRoleTree() {
		return JSONArray.fromObject(roleService.getRoleTree().getNodes())
				.toString();
	}
	 ...
	 * 
	 * @ResponseBody public String getSelectPermission(String roleId,String
	 * moduleCode){
	 * 
	 * List<Map<String,Object>> ens =
	 * service.findPermissionAssignsByCondition(new String[]{"permissionCode"},
	 * "ownerCode = '"+roleId+"' AND permissionCode = '"+moduleCode+"'");
	 * 
	 ...
	 * 
	 * @ResponseBody public String addPermission(String modulecode,String
	 * roleId,boolean isLeaf){
	 * System.out.println("\n\n\n开始了吗"+modulecode+"=="+roleId); return
	 * String.valueOf(service.addPermission(modulecode, roleId,isLeaf)); }
	 * 
	 * @RequestMapping("/delPermission")
	 * 
	 * @ResponseBody public String delPermission(String modulecode,String
	 * roleId,boolean isLeaf){ return
	 * String.valueOf(service.delPermission(modulecode, roleId,isLeaf)); }
	 */
	/**
	 * 删除角色对应的模块
	 * 
