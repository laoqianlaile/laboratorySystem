...
<body>
 	 ...
 	 <div id="searcherArea">
		<div class="list-searcher">
			...
			<span>维修员：</span><input type="text" id="schEmployeeName" name="schEmployeeName" class="form-control" >
		</div>
	</div>
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	      	<div id="addContent" class="row">
                ...
                <div class="col-xs-12 col-md-12">
                  	<label class="control-label" style="margin:8px 0 0 0;">设备维修时间：</label>
                   	<div class="input-group date form_datetime">
		   				<input id="add_repairTime" class="form-control" size="16" type="text" value="" readonly>
	      ...
	      <div class="modal-body">
	      	<div id="editContent" class="row">
                ...
                <div class="col-xs-12 col-md-12">
                  	<label class="control-label" style="margin:8px 0 0 0;">设备维修时间：</label>
                   	<div class="input-group date form_datetime">
		   				<input id="edit_repairTime" class="form-control" size="16" type="text" value="" readonly>
		    			<span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
						<span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
					</div>
               	</div>
