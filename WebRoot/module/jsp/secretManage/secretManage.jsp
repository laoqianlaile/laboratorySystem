...
<body>
	...
	<div id="searcherArea">
	 ...
	 -->	  <div class="col-xs-3 col-md-3 col-lg-3">
		   ...
		   <div class="col-xs-3 col-md-3 col-lg-3"> <label>涉密等级：</label><select id="schclassifiedLevel" name="schclassifiedLevel" class="form-control" aria-describedby="basic-addon1">
...
<script src="../../js/secretManage/secretManage.js"></script>
