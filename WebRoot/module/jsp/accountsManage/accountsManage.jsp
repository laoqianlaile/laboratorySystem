	...
	<div class="container" style="width:100%;">
		<div class="row clearfix">
			<div class="col-md-12" style=" margin-bottom: 10px;">
				<div class="col-md-4 ">
					<label>合同编号：</label> <input type="text" id="query_contractCode"
						name="contractCode" class="form-control" />
				</div>
				<div class="col-md-4 ">
					<label>合同名称：</label> <input type="text" id="query_contractName"
						name="contractName" class="form-control" />
				</div>
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-xs-12 col-md-12">
							<label class="labelName">报账专员</label> <input type="hidden"
								id="employeeID" name="employeeID" /> <input type="text"
								id="add_employeeName" name="employeeName" disabled="disabled"
								class="form-control" aria-describedby="basic-addon1" />
						</div>
						<div class="col-xs-12 col-md-12">
							<label class="labelName">合同编码</label> <select
								id="add_contractCode" name="contractCode"
								oninput="contractCodeChange('add')"
								onpropertychange="contractCodeChange('add')"
								class="form-control">
							</select>
						</div>
						<div class="col-xs-12 col-md-12">
						...
						<div class="col-xs-12 col-md-12">
							<label class="labelName">合同金额</label> <input type="text"
								id="add_contractAmount" name="contractAmount"
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="row" id="edit">
						...
						<div class="col-xs-12 col-md-12">
							<label class="labelName">报账专员：</label> <input type="text"
								id="edit_employeeName" name="employeeName" disabled="disabled"
								class="form-control" aria-describedby="basic-addon1" readonly />
						</div>
						<div class="col-xs-12 col-md-12">
							<label class="labelName">合同编码：</label> <input type="text"
								id="edit_contractCode" name="contractCode" class="form-control"
								readonly />
						</div>
						<div class="col-xs-12 col-md-12">
							<label class="labelName">录入时间：</label> <input type="text"
								id="edit_checkinTime" name="checkinTime" class="form-control"
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
					<button type="button" class="btn btn-primary"
						onclick="editAccounts()">确认</button>
				</div>
			</div>
		</div>
	</div>
...
<script type="text/javascript"
	src="module/js/accountsManage/accountsManage.js"></script>
</html>
