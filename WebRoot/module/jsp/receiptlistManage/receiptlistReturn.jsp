	...
	<div class="container" style="width: 100%;">
		...
		<div class="header">
			<div class="row">
				...
				<div class="col-xs-4">
					<div class="timeLabelDiv"><label class="control-label" >录入时间 :</label></div>
					<div class="input-group date form_datetime timeChooseDiv">
   					<input class="form-control" id="show_createTime" size="16" type="text" value="" readonly="true">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="row">
							...
							<div class="col-xs-12 col-md-12">
								<h4>检测/校准项目:</h4>
								<input type="text" id="show_nameCn" name="nameCn"
									class="form-control" />
							</div>
							<div class="col-xs-12 col-md-12">
								<h4>录入时间:</h4>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="row">
							<div class="col-xs-12 col-md-12">
								<h4>样品ID:</h4>
								<input type="text" id="add_ID" name="factoryCode"
									class="form-control" />
							</div>
						</div>
					</div>
					<div class="modal-footer">
						<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
						<button type="button" class="btn btn-primary" onclick="addSample()">确定</button>
					</div>
				</div>
			</div>
		</div>
