			...
			.bootstrapTable(
					{
						...
						columns : [
								...
								},
								{
									...
									width : '10%',// 宽度
									formatter : function(value, row, index) {
										return "<img src ='module/img/point.png'  onclick='thirdAuditPass(\""
												+ row.ID
												+ "\",\""
												+ row.taskID
												+ "\",\""
												+ row.fileName
												+ "\")'   title='通过审核' style='cursor:pointer;width:18px;height:18px'></span> "
												+ "<img src ='module/img/forbidden_icon.png' onclick='thirdAuditReject(\""
												+ row.ID
												+ "\",\""
												+ row.taskID
												+ "\",\""
												+ row.fileName
												+ "\")'   title='驳回检测报告'  style='cursor:pointer;padding-right:8px;'></span> ";
