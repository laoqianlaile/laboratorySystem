		...
		columns:[{
			...
			formatter:function(value,row,index){
				var btn_editCustodian = '<span class="glyphicon glyphicon-glass" onclick="editCustodian()" data-toggle="tooltip" data-placement="top" title="修改监督人" style="cursor:pointer;color: rgb(10, 78, 143);padding-right:8px;"></span>';
		  		var btn_editDetector = '<span class="glyphicon glyphicon-user" onclick="editDetector(\'' + row.taskManID + "\',\'" + row.departmentID + '\')" data-toggle="tooltip" data-placement="top" title="修改检测人" style="cursor:pointer;color: rgb(10, 78, 143);padding-right:8px;"></span>';
...
// 修改检测人员弹框
function editDetector(data, departmentID){
	taskManID = data;
	$('#sampleCode').text(factoryCode);
	$('#assignType').text('1');
