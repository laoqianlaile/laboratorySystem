...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="Portal/css/onlineQuery/queryDetail2.css">
    ...
    <script src="Portal/js/onlineQuery/queryDetail2.js"></script>
 ...
 <div id="mian">
	...
	<div class="banner clearfloat content">
	   <img src="Portal/images/onlineInquiry_banner.png"/>
            ...
            <div id="contentbody" class="content clearfloat">
