...
<title>实验室简介</title>
	...
	<link rel="stylesheet" type="text/css" href="Portal/css/aboutUs/Introduction.css" >
...
<body>
		...
		<div class="t_black content clearfloat">
			<div class="t_left">
				<div class="t_left_title">
					<img src="Portal/images/about_icon.png"> <label
						style="color:#198ac8;">关于</label> <label>我们</label> <img
						src="Portal/images/left_column.png" style="display:block;width:100%;">
				</div>

				<div class="left_content">
					<img src="Portal/images/point_circle.png">
					<a href="Portal/jsp/aboutUs/Introduction.jsp"
						style="color:#198ac8;">实验室简介</a>
				</div>
				<div class="left_content">
					<img src="Portal/images/point_circle_gray.png">
					<a href="Portal/jsp/aboutUs/HonoraryCertificate.jsp">荣誉资质</a>
				</div>
			</div>
 ...
 <script src="Portal/js/aboutUs/Introduction.js"></script>
</html>
