...
<link rel="stylesheet" type="text/css"
	href="Portal/css/classicCase/CaseDetails.css">
...
<script src="Portal/js/classicCase/caseDetails.js"></script>
</head>
	...
	<div class="header content">
		...
		<div class="line">
			<ul class="tittleline clearfloat">
				...
				<li class="item"><a class="item-inner" href="Portal/jsp/selfApplication/applied.jsp">自助申请</a><span>|</span>
				</li>
	...
	<div class="content clearfloat">
		<div id="leftlist">
			<div class="lefttable panel panel-default">
				...
				<table class="table">
					<tr>
						<td><a href="Portal/jsp/classicCase/ClassicCase.jsp"><img
		...
		<div id="rightlist">
			<div class="righttable panel panel-default">
				...
				<!--  <div class="panel-body">
					...
					<h3 style="text-align:center;">FZK-CTC分散自律调度集中系统</h3>
