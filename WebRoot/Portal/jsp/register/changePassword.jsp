...
<link rel="stylesheet" type="text/css"
	href="Portal/css/register/changePassword.css">
<link rel="stylesheet" type="text/css"
...
<script type="text/javascript"
	src="Portal/js/register/changePassword.js"></script>
...
<body>
	...
	<input type="text" id="name" name="name" style="display: none;"
		value=<%=request.getSession().getAttribute("clientNo")%>>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" id="clientNo1"
									name="clientNo1" readonly="readonly">
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="password" class="form-control" id="oldPassword"
									placeholder="请输入原密码" maxlength="16" onblur="oldPasswordCase()"
									onclick="oldPasswordInput()">
							</div>
							<label for="firstname1" class="col-sm-3 control-label1"
								id="oldPasswordPrompt"></label>
						</div>
						<br />
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="password" class="form-control" id="newPassword1"
									placeholder="请输入新密码" maxlength="16" onblur="newPassword1Case()"
									onclick="newPassword1Input()">
							</div>
							<label for="firstname1" class="col-sm-3 control-label1"
								id="newPassword1Prompt"></label>
						</div>
						<br />
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="password" class="form-control" id="newPassword2"
									placeholder="请输入再次输入新密码" maxlength="16"
									onblur="newPassword2Case()" onclick="newPassword2Input()">
							</div>
							<label for="firstname1" class="col-sm-3 control-label1"
								id="newPassword2Prompt"></label>
						</div>
						<br />
						<div class="form-group">
							<div class="col-sm-2 col-sm-offset-2">
								<button type="button" class="btn btn-primary btn-lg btn-block"
									onclick="changePassword()">确定修改</button>
							</div>
						</div>
					</form>
				</div>
