         ...
         <div class="form"> 
            <form class="form-horizontal" role="form" >
               ...
               <div class="form-group">
                     ...
                     <div class="col-sm-6">
                        <input type="text" class="form-control" id="companyID" placeholder="请输入公司名称" onblur="companyCase()" onclick="companyInput()">
                     </div>
               ...
               <div class="form-group">
                     ...
                     <div class="col-sm-2"> 
                         <input style="opacity:0;filter:alpha(opacity=0);cursor: pointer;z-index:100;" id="license" type="file" name="file" style="display:inline-block;" data-url="fileOperateController/imageUpload.do"  accept="image/jpg,image/jpeg,image/gif,image/png"></input>
                          <p  class="shangchuan" id="shang">点击上传图片</p>
                     </div> 
                ...
                <div class="form-group">
                     ...
                     <div class="col-sm-2"> 
                         <input style="opacity:0;filter:alpha(opacity=0);cursor: pointer;z-index:100;" type = "file" name="file" class="aptitude" id="aptitude" style="display:inline-block;" data-url="fileOperateController/imageUpload.do"  accept="image/jpg,image/jpeg,image/gif,image/png"></input>
                         <p  class="shangchuan" id="shangchuan">点击上传图片</p>
                     </div> 
                      <label for="firstname" class="col-sm-3 control-label1"></label>
               ...
               <div class="form-group">
                     <label for="linkMan" class="col-sm-2 control-label" >法定代表</label>
                     <div class="col-sm-6">
               ...
               <div class="form-group">
	              ...
	              <div class="form-group"> 
				   <div class="col-sm-2 col-sm-offset-2"> 
				    <button type = "button" class="btn btn-primary btn-lg btn-block" onclick="add()">提交</button> 
				   </div>    
				  </div> 
              </form>
          </div>
